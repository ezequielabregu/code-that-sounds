...
![Dr. Ezequiel Abregú](/assets/images/eabregu-pic.jpg){width=70%}
:::
...
This book is based on the `Vanilla`[^2] distribution of Pure Data, which is the most widely used version. However, there are several other distributions that you may find useful for specific projects or needs:
:::
[^2]: [puredata.info/downloads/pure-data](https://puredata.info/downloads/pure-data)
