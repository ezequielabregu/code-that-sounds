...
[Pure Data Tutorials Browser](https://msp.ucsd.edu/Pd_documentation/resources/chapter1.htm#s1.2) (Help → Browser → Manuals) – Within Pd, under the "Manuals" section of the browser, you'll find a range of beginner-focused tutorials, including sections on audio, visuals, and networking. These are ideal for building a foundational understanding.
...
[Pure Data: Electronic Music and Sound Design - Theory and Practice - Volume 1](https://www.amazon.com/Pure-Data-Electronic-Design-Practice/dp/889921221X) - by Francesco Bianchi, Alessandro Cipriani and Maurizio Giri, the book is an overview of the theory and practice of Pure Data, with a glossary of terms and suggested tests that allow students to evaluate their progress.
